...
const projects = [
  ...
  },
  {
    ...
    description: "Plataforma de telemedicina con enfoque en la experiencia del paciente y facilidad de uso para todas las edades.",
    tags: ["Design System", "Mobile", "A11y"],
